...
public class Objc1Module implements StructConverter {
	...
	public Objc1Module(ObjcState state, BinaryReader reader) throws IOException {
		this._state = state;
		...
		if (symbolTableIndex != 0) {
			symbolTable = new Objc1SymbolTable(state, reader.clone(symbolTableIndex));
		}
	}
	...
	public DataType toDataType() throws DuplicateNameException, IOException {
		...
		struct.add(PointerDataType.getPointer(Objc1SymbolTable.toGenericDataType(),
