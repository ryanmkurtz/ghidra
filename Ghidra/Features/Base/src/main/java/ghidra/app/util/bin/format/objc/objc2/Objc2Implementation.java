...
public class Objc2Implementation implements StructConverter {
	...
	public Objc2Implementation(ObjcState state, BinaryReader reader, boolean isSmall)
			throws IOException {
	...
	public Objc2Implementation(ObjcState state, BinaryReader reader)
			throws IOException {
