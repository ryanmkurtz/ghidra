...
public abstract class ObjcMethod implements StructConverter {
	protected ObjcState _state;
	protected long _index;
	protected ObjcMethodType _methodType;

	public ObjcMethod(ObjcState state, BinaryReader reader, ObjcMethodType methodType) {
		this._state = state;
	...
	public void applyTo(Namespace namespace) throws Exception {
		...
		boolean isThumbCode = ObjcUtils.isThumb(_state.program, implementation);
		...
		ObjcUtils.createSymbol(_state.program, namespace, getName(), implementationAddress);
