...
public class Objc1InstanceVariableList implements StructConverter {
	...
	Objc1InstanceVariableList(ObjcState state, BinaryReader reader) throws IOException {
		this._state = state;
		...
		for (int i = 0 ; i < ivar_count ; ++i) {
			ivar_list.add(new Objc1InstanceVariable(state, reader));
		}
	}
