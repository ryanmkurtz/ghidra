...
public class Objc1ProtocolList implements StructConverter {
	...
	Objc1ProtocolList(ObjcState state, BinaryReader reader) throws IOException {
		this._state = state;
		...
		next = new Objc1ProtocolList(state, reader.clone( reader.readNextInt() ));
