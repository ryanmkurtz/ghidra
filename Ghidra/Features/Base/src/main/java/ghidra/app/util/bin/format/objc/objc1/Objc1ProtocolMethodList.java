...
public class Objc1ProtocolMethodList implements StructConverter {
	...
	Objc1ProtocolMethodList(ObjcState state, BinaryReader reader, ObjcMethodType methodType) throws IOException {
		this._state = state;
		...
		for (int i = 0 ; i < method_count ; ++i) {
			method_list.add(new Objc1ProtocolMethod(state, reader, methodType));
		}
	}
