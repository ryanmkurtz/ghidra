...
public interface Loader extends ExtensionPoint, Comparable<Loader> {
	 ...
	 * @param name A suggested name for the primary {@link Loaded} {@link DomainObject}. 
	 ...
	 */
	public record ImporterSettings(ByteProvider provider, String name, Project project,
			String projectRootPath, String rootRelativeFolderPath, boolean mirrorFsLayout,
			LoadSpec loadSpec, List<Option> options, Object consumer, MessageLog log,
			TaskMonitor monitor) {}
