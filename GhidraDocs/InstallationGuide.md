...
## Table of Contents
 ...
 6. [Installing the Debugger's Python Dependencies](#installing-the-debuggers-python-dependencies)
 7. [Running Ghidra](#running-ghidra)
    * [GUI Mode](#gui-mode)
 ...
 9. [Ghidra Development](#ghidra-development)
...
11. [Troubleshooting and Help](#troubleshooting-and-help)
...
### Software
* Java 21 64-bit Runtime and Development Kit (JDK) (see <a href="#JavaNotes">Java Notes</a>)</li>
  <ul>
