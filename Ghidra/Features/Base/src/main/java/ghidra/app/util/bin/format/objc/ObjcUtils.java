...
public final class ObjcUtils {
	 ...
	 */
	public static void clear(ObjcState state, MemoryBlock block) throws Exception {
	 ...
	 */
	public static void setThumbBit(ObjcState state, Address address) {
	...
	public final static String formatAsObjectiveC(FunctionSignature signature,
			ObjcMethodType methodType, boolean appendSemicolon)
	...
	public final static void createMethods(ObjcState state) {
		...
		for (Address address : addresses) {
			...
			ObjcUtils.setThumbBit(state, address);
	...
	public final static void createInstanceVariablesC2_OBJC2(ObjcState state) {
	 ...
	 */
	public final static void fixupReferences(List<String> sectionNames, ObjcState state) {
		...
		while (referenceIterator.hasNext()) {
			...
			for (Reference reference : references) {
				...
				if (ObjcUtils.isNull(reference.getToAddress())) {
					referenceManager.delete(reference);
				}
				if (ObjcUtils.isThumb(state.program, reference.getToAddress())) {
					referenceManager.delete(reference);
	...
	/**
	 * Gets a {@link List} of {@link MemoryBlock}s that match the given section name
	 * 
