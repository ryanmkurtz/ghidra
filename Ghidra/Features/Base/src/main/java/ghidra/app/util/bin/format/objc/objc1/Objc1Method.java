...
public class Objc1Method extends ObjcMethod {
	...
	Objc1Method(ObjcState state, BinaryReader reader, ObjcMethodType methodType) throws IOException {
		super(state, reader, methodType);

		name      = ObjcUtils.dereferenceAsciiString(reader, state.is32bit);
		signature = ObjcUtils.dereferenceAsciiString(reader, state.is32bit);
