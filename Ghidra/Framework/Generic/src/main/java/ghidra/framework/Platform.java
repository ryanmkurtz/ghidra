...
public enum Platform {
	 ...
	 */
	MAC_X86_32(OperatingSystem.MAC_OS_X, Architecture.X86, "macos_x86_32", ".dylib", ""),

	/**
	 * Identifies a macOS x86 64-bit OS.
	 */
	MAC_X86_64(OperatingSystem.MAC_OS_X, Architecture.X86_64, "macos_x86_64", ".dylib", ""),

	/**
	 * Identifies a macOS ARM 64-bit OS.
	 */
	MAC_ARM_64(OperatingSystem.MAC_OS_X, Architecture.ARM_64, "macos_arm_64", ".so", ""),
	 ...
	 */
	MAC_UNKNOWN(OperatingSystem.MAC_OS_X, Architecture.UNKNOWN, "macos_x86_64", ".dylib", ""),
	 ...
	 */
	@Deprecated(since = "10.1", forRemoval = true)
	MAC_OSX_32(OperatingSystem.MAC_OS_X, Architecture.X86, "macos_x86_32", ".dylib", ""),
	 ...
	 */
	@Deprecated(since = "10.1", forRemoval = true)
	MAC_OSX_64(OperatingSystem.MAC_OS_X, Architecture.X86_64, "macos_x86_64", ".dylib", "");
