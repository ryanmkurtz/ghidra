...
public final class ObjcUtils {
	...
	/**
	 * The size that should be reserved for symbols starting with {@link #OBJC_CLASS_SYMBOL_PREFIX} 
	 * in the {@link MemoryBlock#EXTERNAL_BLOCK_NAME EXTERNAL block}. This will allow some room for 
	 * the recreation of external method thunks as they are discovered during analysis.
	 */
	public static final int OBJC_CLASS_SYMBOL_EXTERNAL_CHUNK_SIZE = 0x100;
