...
public class Objc2InstanceVariable implements StructConverter {
	...
	public Objc2InstanceVariable(ObjcState state, BinaryReader reader) throws IOException {
		this._state = state;
		...
		long typeIndex = ObjcUtils.readNextIndex(reader, state.is32bit);
